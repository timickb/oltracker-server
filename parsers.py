...
class OlympiadaRu():
    def __init__(self):
        ...
        self.BASE_URL_NEXT = 'https://info.olimpiada.ru/events?filter=1&reg_inc=1&subject%5B{}%5D=on&sub_inc=1&class%5B{}%5D=on&type%5B{}%5D=on'
        self.HEADERS = {
    ...
    def get_current_events(self, subject=-1, schclass=-1, oltype=-1):
        ...
        if request.status_code == 200:
            ...
            if counter != None:
                pages_amount = len(counter.find_all('li'))-2
